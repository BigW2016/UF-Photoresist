...
//LCD 4 bit interface is used 4-7 PINS(single port pins)
//#define LCD_4BIT_HIGHT 
//LCD 4 bit interface is used 0-3 PINS (single port pins)
//#define LCD_4BIT_LOW 
...
#if defined (LCD_4BIT_HIGHT) || defined (LCD_4BIT_LOW) || defined (LCD_8BIT) //if aligned mode
